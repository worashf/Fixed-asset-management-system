<%-- 
    Document   : finishedRequest
    Created on : Feb 7, 2021, 10:09:02 AM
    Author     : best
--%>
<%-- 
    Document   : storeKepeerRequest
    Created on : Feb 5, 2021, 6:25:24 AM
    Author     : best
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <s:url var="requestCompletedByStoreKepeerurl" value ="/request/finished-request"/> 
                            ...
                            <div class="row">
                                ...
                                <c:if test="${param.act eq 'kepeer_request_completed'}">
                                    <h3 class=" mt-3 ml-5 text-success"> Completed successfully</h3>
                                </c:if>
                            </div>
                                        ...
                                        <tbody>
                                            <c:forEach var ="req" items ="${requests}">
                                                <tr> 
                                                    ...
                                                    <s:url var="url_approved_detail" value="/request/request-manager-approved-detail-page">
                                                    ...
                                                    <td> 
                                                        <a href="${url_approved_detail}">View detail</a>
                                                    </td>

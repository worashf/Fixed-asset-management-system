                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav navbar bg-light">
                                ...
                                <li class =" nav-item font-weight-bold"><a  class ="nav-link " href="${report_url}" ><h5>Assigned Report</h5></a>
                                </li>
                                 <s:url var="storereport_url" value ="/report/storeAssetReport"/>
                                <li class =" nav-item font-weight-bold mr-auto"><a  class ="nav-link " href="${storereport_url}" ><h5>Store Report</h5></a>
                                </li>
                            </ul>

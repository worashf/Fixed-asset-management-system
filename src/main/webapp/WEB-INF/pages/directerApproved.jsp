                        ...
                        <div class="panel-body">
                         ...
                         <s:url var="requestApproveByStoreKepeerurl" value ="/request/store-kepeer-request-list"/>     
                            ...
                            <div class="row">
                                ...
                                <div class=" mt-3 col-6">
                                    ...
                                    <label class="text-primary">የጠያቂ የስራ ክፍል: </label>   <span class ="mr-3"> ${requests.user.empployee.department.name}</span>  </br>
                            ...
                            <s:url var ="requestManagerApprove" value="/request/request-manager-Approve"/>
                         ...
                         <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <f:textarea  path  ="managerComment" type="text"  rows="2" class="form-control" />
                                ...
                                <s:url var="url_manager_decline" value="/request/manager-request-decline">
                                    <s:param name="requestId" value="${requests.requestId}"/>
                                </s:url> 
                                <div class =" col-1">
                                    <a class ="nav-link btn-lg btn btn-primary" href="${url_manager_decline}"> Decline </a>
                                </div>
                            </div>
